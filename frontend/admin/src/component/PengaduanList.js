    ...
    render(){
        return (
            <div className="card col-sm-12 my-1">
                ...
                {/* image */}
                <img alt={this.props.foto} src={this.props.foto} className="img-fluid" alt="Responsive Image" />
            </div>
                    ...
                    <div className="col-sm-2">
                        <button type="button" class="btn btn-sm btn-outline-primary btn-block mt-4" onClick={this.props.onGet}>
